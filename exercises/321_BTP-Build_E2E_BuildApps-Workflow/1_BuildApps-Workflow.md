...
3. When you find the template app, select the **Navigate** arrow on the right-hand side.
    ...
    ![Save as new](./Images/save_new_project.png)

4. Select the **Versions** tab and select the **Options** icon.
   Then choose **Save As New Project**

5. ![Save as new](./Images/save_template_2.png)

6. On the next screen, enter the following:

    | Input Field    | Input Value    |
    | -------------- | -------------- |
    | Project Name   | **Create Sales Order XP262-XXX (your user number)** |
    | Description    | **SAP Build Apps Sales Order Project XP262-XXX (your user number)** |

7. Select **Save As New**.

    ![Name project](./Images/save_template.png)
